...
def lightgbm(config, train_data_df, test_data_df, pc=False, scal=False, lasso=False, minmax=False):
    ...
    results_df.to_csv('Results/results_lightgbm2.csv', mode='a', index=False)
